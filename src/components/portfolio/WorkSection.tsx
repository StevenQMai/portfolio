  ...
  return (
    <section className="mb-16 animate-fadeIn">
      <div className="flex items-center gap-1 mb-8">
        ...
        <h2 className="text-3xl font-bold font-['Playfair_Display']">Work Experience</h2>
      </div>
      ...
      {personalInfo.experience.length > 0 ? (
          ...
          {personalInfo.experience.map((exp, index) => (
            <div key={index} className={`border-l-2 pl-6 relative ${themeColors.primaryBorder}`}>
              ...
              <div className="flex items-center gap-3 mb-2">
                ...
                <div>
                  <h3 className="text-xl font-semibold leading-tight">{exp.position}</h3>
        ...
        <div className={`p-8 rounded-xl ${cardBgClasses} border ${borderClasses} text-center`}>
          ...
          <h3 className="text-xl font-semibold mb-2">Building experience</h3>
